        ...
        <div className='flex flex-col min-[1200px]:flex-row min-[1200px]:items-center items-start  justify-center mt-40 mx-4 md:mx-10 lg:mx-20 gap-12 p-5 '>
            <div className='flex flex-col '>
              ...
              h-[6px] md:h-[8px] z-3">
                ...
                <p className='text-[16px] font-normal max-w-[543px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc efficitur urna in dictum suscipit. Suspendisse maximus ipsum sem. Donec ut justo et leo congue lacinia vitae nec arcu.</p>
